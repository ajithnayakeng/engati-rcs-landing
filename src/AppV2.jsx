            ...
            <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#DDDDDD] transition-all duration-200">
                <div className="max-w-7xl mx-auto px-8 h-16 flex items-center">
                    <div className="flex items-center select-none cursor-pointer" onClick={() => { setPage(1); setCompanyName(''); }}>
                        <svg width="140" height="40" viewBox="0 0 856 247" fill="none" className="h-8 w-auto" xmlns="http://www.w3.org/2000/svg">
...
const DynamicIsland = ({ active }) => (
    <motion.div
        ...
        className="absolute top-4 left-1/2 -translate-x-1/2 bg-black rounded-[20px] z-50 flex items-center justify-center overflow-hidden shadow-sm"
    >
        {/* Sensor Cutouts */}
        ...
        >
            ...
            <div className="relative">
                ...
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                    <path d="M12 4L22 28L17 30L12 4Z" fill="black" stroke="white" strokeWidth="2" />
                </svg>
            </div>
        </motion.div>
    );
